<template>
  <main class="container">
    <header class="product__option">
      <div class="product__filter">
        <details class="product__filter_item">
          <summary>
            <span>FILTER</span
            ><svg
              width="15"
          ...
          <details>
            ...
            >
            <label
              ><input type="radio" name="category" value="Bags" />Bags</label
            >
            <label
              ><input type="radio" name="category" value="Denim" />Denim</label
            >
            <label
              ><input
                type="radio"
            ...
            >
            <label
              ><input type="radio" name="category" value="Polos" />Polos</label
            >
            <label
              ><input
                type="radio"
            ...
            >
            <label
              ><input type="radio" name="category" value="Shoes" />Shoes</label
            >
            <label
              ><input
                type="radio"
            ...
            >
            <label
              ><input type="radio" name="category" value="Tanks" />Tanks</label
            >
          </details>
          <details>
          ...
          <details>
            ...
            <label><input type="radio" name="designer" value="11" />11</label>
            <label><input type="radio" name="designer" value="22" />22</label>
            <label><input type="radio" name="designer" value="33" />33</label>
          </details>
        </details>
      </div>
      <ul class="product__sort">
        <li>
          <details class="product__sort_item">
            <summary>
              TRENDING NOW<svg
                width="11"
                height="6"
            ...
            <div>
              ...
              <label><input type="checkbox" value="Hot Goth" />Hot Goth</label>
              <label
                ><input type="checkbox" value="Y2K Fashion" />Y2K Fashion</label
              >
            </div>
          </details>
        </li>
    ...
    <section class="product__pagination">
      <ul>
        ...
        <li><a href="#">5</a></li>
        <li><a href="#">6</a></li>
        <li class="product__pagination_dots">.....</li>
        <li><a href="#">20</a></li>
        <li>
          <a href="#">
            <svg
